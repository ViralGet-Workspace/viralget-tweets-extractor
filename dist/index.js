...
app.get("/twitter/extract-influencers/:categoryID", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { categoryId } = req.params;
    yield twitterExtractorMainController.fetchByCategory(categoryId);
    res.send('OK');
}));
